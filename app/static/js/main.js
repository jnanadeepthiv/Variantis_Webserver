...
function showDefaultPopup() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Content for beforeunload below: 
    // function sendCleanupRequest() {
    //     if (cleanupRequestSent) {
    //         //DEBUG //console.log("Cleanup request already sent. Skipping.");
    //         return;
    //     }
    //     ////DEBUG //console.log("Session ID from window:", window.sessionId); // Debugging
    //     const session_id = getCookie('session_id');
    //     if (!session_id) {
    //         //DEBUG //console.log("No session ID found. This might be a new user.");
    //         return;
    //     }
    //
    //     const csrfToken = document.getElementById('csrf_token')?.value;
    //     if (!csrfToken) {
    //         console.error("CSRF token not found for cleanup request");
    //         return;
    //     }
    //
    //     //DEBUG //console.log("Sending cleanup request with session ID:", session_id);
    //
    //     const payload = {
    ...
    //     .then(data => {
    //         //DEBUG //console.log("Cleanup request successful:", data);
    //         window.location.href = '/variantis/home?message=Your session has ended';
    //     })
    //     .catch(error => {
    //         console.error("Failed to send cleanup request:", error);
    //     });
    //
    //     cleanupRequestSent = true;
    // }
    //
    // window.addEventListener('beforeunload', function () {
    //     //DEBUG //console.log("beforeunload event triggered");
    //     sendCleanupRequest();
    // });
    //
    // window.addEventListener('pagehide', function () {
    //     //DEBUG //console.log("pagehide event triggered");
    //     sendCleanupRequest();
    // });
  });